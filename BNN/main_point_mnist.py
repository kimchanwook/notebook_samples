...
#TODO: Need to write these two: trainer + evaluate_mnist_uncertainty
...
def main():
    ...
    if not load:
        ...
        logging.info(
            '## Finished training, the best observed validation error: {}, total training time: {}, total validation time: {} ##'.format(
